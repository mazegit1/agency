...
const Hero = () => {
  return (
    ...
    <div className="hero-title flex flex-col gap-[26px] items-center ml-0 mx-auto mt-[50px]">
        ...
        <button className='border    font-bold border-[#377DFF] bg-sky-700 text-teal-50 text-[#377DFF] py-3 px-[50px] rounded-3xl hover:text-black hover:bg-slate-200 active:bg-zinc-600 active:border-none active:text-[#ffffff]'>Start Project</button>
    </div>
